...
import { DefaultItem, TelItem } from './merchant-item';

require('./merchant-item-list.less');
    ...
    return(
      <div>
        <dl className="item-list">
          <dt className="item-tit"  style={ showTitle }><a>{ itemTitle }</a></dt>
          { itemList }
        </dl>
      </div>
    )
